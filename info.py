...
API_ID = int(environ.get('API_ID', '23586931'))
API_HASH = environ.get('API_HASH', 'df1865a4dd5b6f950821909d74610b20')
BOT_TOKEN = environ.get('BOT_TOKEN', 'Eshwar0000/PROFESSOR-BOT
Jump to:AAF1dwXAmMGbLFEIyb_eHGow9Q_561bWf2U')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5045115971').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002114355413').split()]
